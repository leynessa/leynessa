...
void setup() {
  ...
  strs[0][0] = "Hey there!";
  strs[0][1] = "My name is Ashley Williams.";

  strs[1][0] = "I'm a Full stack Web Developer";
  strs[1][1] = "I sm currently located in Brazil";

  strs[2][0] = "I've my web development traing at the Le Wagon School";
  strs[2][1] = "I am fluent in Ruby, JavaScript, and HTML & CSS.";

  strs[3][0] = "I love creating apps and learning new languages";
  strs[3][1] = "You can even find the Processing source code for this below!";

  strs[5][0] = "contact me!";
  strs[5][1] = " email: leynessa1@gmail.com";
}
